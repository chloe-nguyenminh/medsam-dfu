...
def build_sam_vit_h_lora(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam(
...
build_sam = build_sam_vit_h_lora
...
sam_lora_model_registry = {
    "default": build_sam_vit_h_lora,
    "vit_h": build_sam_vit_h_lora,
